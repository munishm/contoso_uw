# Data Model: FastAPI Implementation (Cosmos DB)

**Feature**: 003-fastapi-impl  
**Date**: 2025-12-17  
**Purpose**: Define Cosmos DB container schemas and Pydantic models
...
VALID_CASE_TRANSITIONS = {
    ...
    CaseStatus.DELETED: [],  # Restore handled separately
}
